...
public class WebServer {
    ...
    private static void initDatabase() throws SQLException {
        ...
        try (Connection conn = getConnection();
            ...
            // Attempt to alter existing tables to add AUTO_INCREMENT if not already set
            try { stmt.executeUpdate("ALTER TABLE Donor MODIFY COLUMN DonorID INT AUTO_INCREMENT"); } catch (Exception e) {}
            try { stmt.executeUpdate("ALTER TABLE BloodStock MODIFY COLUMN StockID INT AUTO_INCREMENT"); } catch (Exception e) {}
            try { stmt.executeUpdate("ALTER TABLE Recipient MODIFY COLUMN RecipientID INT AUTO_INCREMENT"); } catch (Exception e) {}
            try { stmt.executeUpdate("ALTER TABLE BloodRequest MODIFY COLUMN RequestID INT AUTO_INCREMENT"); } catch (Exception e) {}
        }
    }
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if ("GET".equalsIgnoreCase(method)) {
                ...
                try {
                    ...
                    Integer id = getJsonIntField(body, "DonorID");
                    Integer bgid = getJsonIntField(body, "BG_ID");
    ...
    static class RecipientsHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if ("GET".equalsIgnoreCase(method)) {
                ...
                try {
                    String body = getBody(exchange);
                    Integer id = getJsonIntField(body, "RecipientID");
                    Integer bgid = getJsonIntField(body, "BG_ID");
                    String name = getJsonStringField(body, "Name");
                    String phone = getJsonStringField(body, "Phone");
    ...
    static class StockHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if ("GET".equalsIgnoreCase(method)) {
                ...
                try {
                    String body = getBody(exchange);
                    Integer id = getJsonIntField(body, "StockID");
                    Integer bgid = getJsonIntField(body, "BG_ID");
    ...
    static class RequestsHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if ("GET".equalsIgnoreCase(method)) {
                ...
                try {
                    String body = getBody(exchange);
                    Integer id = getJsonIntField(body, "RequestID");
                    Integer recID = getJsonIntField(body, "RecipientID");
                    Integer bgid = getJsonIntField(body, "BG_ID");
